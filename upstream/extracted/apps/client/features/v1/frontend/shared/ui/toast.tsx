...
import { UserSettingKey } from "@/features/v1/frontend/shared/user/models"
import { useUser } from "@/features/v1/frontend/shared/user/user-store"
...
>(({ className, variant, ...props }, ref) => {
	...
	// Convert snapshot entries to a new Map
	const settingsMap = new Map(
		Array.from(settings.entries() as IterableIterator<[UserSettingKey, string]>),
	)
	if (settingsMap.get(UserSettingKey.TOAST_NOTIFICATIONS_ENABLED) === "false") {
		return null
	}
